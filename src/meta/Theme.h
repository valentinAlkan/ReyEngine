...
//   };
   ...
   struct StyleRole {
      Color colorPrimary; //for gradient
      Color colorSecondary; //for gradient
      Color colorTertiary; //for whatever
      Color colorDisabled; //for whatever
      Fill fillType = Fill::NONE;
      Outline outlineType = Outline::NONE;
   };
...
//   };
   ...
   public:
      Theme(const std::string& instanceName = "DefaultTheme"){
         //apply defaults
         background.fillType = Fill::SOLID;
      ...
      StyleRole foreground;
      StyleRole highlight;
      float roundness;
      int roundnessSegments;
      ReyEngine::ReyEngineFont font;
      Margins<float> layoutMargins;
      float lineThick;
