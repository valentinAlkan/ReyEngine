...
void Window::exec(){
   ...
   std::function<void(shared_ptr<Node>)> applyProcess = [&](shared_ptr<Node> widget){
   ...
   while (!WindowShouldClose()){
      ...
      if (mouseDelta) {
         ...
         std::function<std::optional<std::shared_ptr<Node>>(const std::shared_ptr<Node>&)> askHover = [&](const std::shared_ptr<Node>& widget)->std::optional<std::shared_ptr<Node>>{
            //ask this widget to accept the hover
            auto isInside = [&](const std::shared_ptr<Node>& widget){
               return widget->getGlobalRect().isInside(event.globalPos);
            };

            auto process = [&](const std::shared_ptr<Node>& widget) -> std::optional<std::shared_ptr<Node>> {
               bool _isInside = isInside(widget);
               if (widget->_acceptsHover && _isInside) {
                  return widget;
               }
               return nullopt;
            };

            auto pass = [&](const std::shared_ptr<Node>& widget) -> std::optional<std::shared_ptr<Node>>{
...
//            Application::printDebug() << "Asking widget " << widget->getName() << " to accept hover " << endl;
            std::optional<std::shared_ptr<Node>> handled;
...
///////////////////////////////////////////////////////////////////////////////////////////
bool Window::setProcess(bool process, std::shared_ptr<Node> widget) {
   //return if the operation was successful
   return process ? _processList.add(widget) != nullopt : _processList.remove(widget) != nullopt;
}

///////////////////////////////////////////////////////////////////////////////////////////
bool Window::isProcessed(const std::shared_ptr<Node>& widget) const {
   return _processList.find(widget).has_value();
}

///////////////////////////////////////////////////////////////////////////////////////////
std::optional<shared_ptr<Node>> Window::ProcessList::add(std::shared_ptr<Node> widget) {
...
///////////////////////////////////////////////////////////////////////////////////////////
std::optional<std::shared_ptr<Node>> Window::ProcessList::remove(std::shared_ptr<Node> widget) {
...
///////////////////////////////////////////////////////////////////////////////////////////
std::optional<std::shared_ptr<Node>> Window::ProcessList::find(const std::shared_ptr<Node> &widget) const {
...
///////////////////////////////////////////////////////////////////////////////////////////
void Window::setRoot(std::shared_ptr<Node>& newRoot) {
