...
#include "rlgl.h"
#include <cstring>
#include "ReyEngineDefaultFont.h"
...
/////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
WindowSpace<Pos<R_FLOAT>> ReyEngine::getScreenCenter() {
...
/////////////////////////////////////////////////////////////////////////////////////////
Size<float> ReyEngine::getWindowSize() {
   return {(float)GetRenderWidth(), (float)GetRenderHeight()};
}

/////////////////////////////////////////////////////////////////////////////////////////
Pos<float> ReyEngine::getWindowPosition() {
   return GetWindowPosition();
}

/////////////////////////////////////////////////////////////////////////////////////////
void ReyEngine::setWindowPosition(Pos<float> pos) {
...
ReyEngine::ReyEngineFont::ReyEngineFont(const std::string& fontFile, int fontSize){
   const FileSystem::Path fontPath(fontFile);
   if (!fontPath.exists()) {
      //load default font
      if (!fontFile.empty()) {
         // log if a path was passed in but isn't valid
         Logger::error() << "Invalid font file : " << fontPath.str() << endl;
      }
      font = getDefaultFont();
      size = fontSize;
      return;
