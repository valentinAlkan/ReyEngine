...
namespace ReyEngine {
   ...
   public:
      ...
      auto& getThemePtr() {return theme;}
      const auto& getThemePtr() const {return theme;}
      void setTheme(const std::shared_ptr<Theme>& newTheme){theme = newTheme;}
   ...
   protected:
      ...
      virtual void render2D(RenderContext&) const override {};
