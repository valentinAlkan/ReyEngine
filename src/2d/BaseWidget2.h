...
namespace ReyEngine::Internal{
   ...
   {
      //      //input
      Handled _process_unhandled_input(const BaseEvent&, const std::optional<UnhandledMouseInput>&); //pass input to children if they want it and then process it for ourselves if necessary
